...
inline bool __Race_HistoricalStopBlocksNestedScan()
{
   ...
   // M15 hard stop must block only MAJ-world nested rescans. MIN archive scans
   // are bounded by their own MinorStarter->MinorOff range and must remain able
   // to finish without corrupting the hard-won minor range logic.
