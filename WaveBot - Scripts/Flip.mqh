...
// Type 3 UP  : bullish mother contains one or more inside candles, then another
//              bullish candle body-breaks mother High. Range = mother High..Low.
// Type 3 DOWN: bearish mother contains one or more inside candles, then another
//              bearish candle body-breaks mother Low. Range = mother High..Low.
// ============================================================================
                            ...
                            const datetime to_time)
{
   ...
   for(int i = 0; i < n; ++i)
   {
      ...
      FlipZone t3;
      if(__Flip_BuildType3UP(rates, n, i, from_time, to_time, t3))
      {
         __Flip_AddUP(t3);
         __Flip_DrawUP(t3, draw_count);
      }
   }
                              ...
                              const datetime to_time)
{
   ...
   for(int i = 0; i < n; ++i)
   {
      ...
      FlipZone t3;
      if(__Flip_BuildType3DOWN(rates, n, i, from_time, to_time, t3))
      {
         __Flip_AddDOWN(t3);
         __Flip_DrawDOWN(t3, draw_count);
      }
   }
