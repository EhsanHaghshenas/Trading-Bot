...
// This is intentionally separated from the M1 hard stop: the M15 master can
// stop its own chart after publishing DONE, while the M1 slave can continue its
// own terminal scan from the already-published bridge events.
